...
class MetronomeApp:
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Metronome-RS Demo", 
                               font=("Arial", 16, "bold"))
        ...
        ttk.Label(main_frame, text="Time Signature:").grid(row=2, column=0, sticky=tk.W, pady=5)
        self.time_sig_var = tk.StringVar(value="4")
        self.time_sig_entry = ttk.Entry(main_frame, textvariable=self.time_sig_var, width=10)
        ...
        type_combo = ttk.Combobox(main_frame, textvariable=self.metronome_type, 
        ...
        # Test beep button
        test_btn = ttk.Button(button_frame, text="Test Beep", 
            ...
            if self.metronome_type.get() != "Simple":
                try:
                    ...
                    if time_sig <= 0 or time_sig > 16:
                        messagebox.showerror("Error", "Time signature must be between 1 and 16")
                        return
                except ValueError:
    ...
    def test_beep(self):
        ...
        def beep_in_thread():
            try:
                ...
                self.root.after(0, lambda: messagebox.showerror("Error", f"Failed to play beep: {str(e)}"))
