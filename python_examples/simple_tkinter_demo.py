...
class SimpleMetronomeApp:
    ...
    def setup_ui(self):
        ...
        # Title
        ttk.Label(frame, text="Simple Metronome", font=("Arial", 14, "bold")).pack(
            pady=(0, 20)
        )
        ...
        ttk.Entry(bpm_frame, textvariable=self.bpm_var, width=8).pack(
            side=tk.LEFT, padx=(5, 0)
        )

        # Start/Stop button
        self.btn = ttk.Button(
            frame, text="Start Metronome", command=self.toggle_metronome
        )
